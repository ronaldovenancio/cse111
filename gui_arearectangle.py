...
def main():
    ...
    arearectangle_main_window(frm_main)
...
def arearectangle_main_window(frm_main):
    ...
    lbl_width = Label(frm_main, text="Width (0 - 1,000,000):")

    # Create an integer entry box where the user will enter her width.
    ent_width = FloatEntry(frm_main, width=6, lower_bound=0, upper_bound=1000000)


     # Create a label that displays "height:"
    lbl_height = Label(frm_main, text="Length (0 - 1,000,000):")

    # Create an integer entry box where the user will enter her height.
    ent_height = FloatEntry(frm_main, width=6, lower_bound=0, upper_bound=1000000)

    # Create a label that displays "unity of area"
    lbl_area_units = Label(frm_main, text="unity of area")

    # Create a label that displays "Rates:"
    lbl_length = Label(frm_main, text="Width x Height:")

    # Create labels that will display the results.
    lbl_area = Label(frm_main, width=12)
    # lbl_fast = Label(frm_main, width=3)
    lbl_area_units = Label(frm_main, text="unit of area")
    ...
    lbl_area_units.grid(row=0, column=4, padx=0, pady=3)

    lbl_area_units.grid(     row=1, column=0, padx=(30,3), pady=3)
