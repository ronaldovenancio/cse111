def main():
    ...
    print(f" {mpg:.1f} miles per gallons")
...
def miles_per_gallon(start_miles, end_miles, amount_gallons):
    ...
    """
    efficiency_mpg = abs((end_miles - start_miles)/amount_gallons)
    return efficiency_mpg
...
def lp100k_from_mpg(mpg):
    ...
    """
    efficiency_lp100k = 235.215/mpg
    return efficiency_lp100k
